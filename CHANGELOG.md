...
## 2026-05-21 V2.0.9 更新说明

### ✨ 新功能
- 优化模型路由，特定后缀的模型自动分配到对应服务。
- 新增一键安装脚本，支持 Linux、macOS 和 Windows 系统，简化安装流程。

### 🐛 修复
- 修复了通过 curl 管道安装时可能出现的交互问题。
- 修复了多个跨平台兼容性问题，提升版本显示和更新检查的准确性。

### 📚 文档
- 更新了 CHANGELOG.md 文件。
- 简化了 README 中的安装说明，推广一键安装方式。
- 全面重写文档以确保与软件实际行为一致。
